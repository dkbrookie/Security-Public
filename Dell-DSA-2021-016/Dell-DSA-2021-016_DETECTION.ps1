...
If ($currentBiosVersion -lt $minimumSafeBiosVersion) {
    $outputLog += "!Failed: This machine is an affected model and does not meet the minimum BIOS version requirement. This machine is vulnerable and needs to be updated."
} Else {
